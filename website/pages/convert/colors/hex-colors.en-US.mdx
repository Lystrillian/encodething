...
The basic colors are 16 colors defined in the [HTML](https://en.wikipedia.org/wiki/HTML "HTML") 4.01 specification, ratified in 1999, as follows (names are defined in this context to be case-insensitive):
