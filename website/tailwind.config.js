  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        'gray-main': '#A1A1A1',
        'white-main': '#D8D8DA',
        'ds-focus': 'hsl(var(--ds-blue-700, hsl(212 100% 48%)))',
        ...
        'geist-color-cyan-gesit-cyan-light':
        ...
        'vaul-overlay-background':
          'hsl(var(--vaul-verlay-background, 0 0 100%))',
        'vaul-overlay-background-end':
          'hsl(var(--vaul-overlay-background-end, 0 0 0% / 0.4))',
        'vaul-overlay-background-start':
          'hsl(var(--vaul-overlay-background-start, 0 0 0% / 0))',
        dark: {
